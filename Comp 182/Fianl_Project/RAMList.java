...
public class RAMList {
	 public void ram() {
		    ...
		    System.out.print("Enter a number: ");
			   ...
			   int opt =0;
			   while(!exit){
					System.out.println("List of RAM's: ");
					System.out.println("[0]Return to Select screen");
				   for(int i = 0; i < make.ramList.size(); i++) {
					   int number = i + 1;
						System.out.println("[" + number + "]"+make.ramList.get(i) + " price" + make.ramPriceList.get(i));
					}
			       ...
			       switch(opt){
			          ...
			          case 1 :
			            	cal.addList(make.ramList.get(opt));
			            	cal.addCost(make.ramPriceList.get(opt));
			            	System.out.println("you chose to buy " + make.ramList.get(opt) + " and price will be " + make.ramPriceList.get(opt)+"$");
			            	exit = true;
