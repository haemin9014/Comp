	 ...
	 public void cooler() {
		    ...
		    System.out.print("Enter a number: ");
			   ...
			   while(!exit){
				   ...
				   for(int i = 0; i < make.coolerList.size(); i++) {
					   int number = i + 1;
						System.out.println("[" + number + "]"+make.coolerList.get(i) + " price" + make.coolerPriceList.get(i));
					}
			       ...
			       switch(opt){
			          ...
			          case 1 :
			            	cal.addList(make.coolerList.get(opt));
			            	cal.addCost(make.coolerPriceList.get(opt));
			            	System.out.println("you chose to buy " + make.coolerList.get(opt) + " and price will be " + make.coolerPriceList.get(opt)+"$");
			            	exit = true;
