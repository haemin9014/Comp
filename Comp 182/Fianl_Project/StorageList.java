...
public class StorageList {
	 public void storage() {
		    ...
		    System.out.print("Enter a number: ");
			   ...
			   int opt =0;
			   while(!exit){
					System.out.println("List of Storage's: ");
					System.out.println("[0]Return to Select screen");
				   for(int i = 0; i < make.storageList.size(); i++) {
					   int number = i + 1;
						System.out.println("[" + number + "]"+make.storageList.get(i) + " price" + make.storagePriceList.get(i));
					}
			       ...
			       switch(opt){
			          ...
			          case 1 :
			            	cal.addList(make.storageList.get(opt));
			            	cal.addCost(make.storagePriceList.get(opt));
			            	System.out.println("you chose to buy " + make.storageList.get(opt) + " and price will be " + make.storagePriceList.get(opt)+"$");
			            	exit = true;
