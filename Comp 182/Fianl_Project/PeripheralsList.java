...
public class PeripheralsList {
	 public void peripherals() {
		    ...
		    System.out.print("Enter a number: ");
			   ...
			   int opt =0;
			   while(!exit){
					System.out.println("List of peripheral's: ");
					System.out.println("[0]Return to Select screen");
				   for(int i = 0; i < make.peripheralsList.size(); i++) {
					   int number = i + 1;
						System.out.println("[" + number + "]"+make.peripheralsList.get(i) + " price" + make.peripheralsPriceList.get(i));
					}
			       ...
			       switch(opt){
			          ...
			          case 1 :
			            	cal.addList(make.peripheralsList.get(opt));
			            	cal.addCost(make.peripheralsPriceList.get(opt));
			            	System.out.println("you chose to buy " + make.peripheralsList.get(opt) + " and price will be " + make.peripheralsPriceList.get(opt)+"$");
			            	exit = true;
