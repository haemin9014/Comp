	 ...
	 public void caseList() {
		    ...
		    System.out.print("Enter a number: ");
			   ...
			   while(!exit){
				   ...
				   for(int i = 0; i < make.caseList.size(); i++) {
					   int number = i + 1;
						System.out.println("[" + number + "]"+make.caseList.get(i) + " price" + make.casePriceList.get(i));
					}
			       ...
			       switch(opt){
			          ...
			          case 1 :
			            	cal.addList(make.caseList.get(opt));
			            	cal.addCost(make.casePriceList.get(opt));
			            	System.out.println("you chose to buy " + make.caseList.get(opt) + "and price will be " + make.casePriceList.get(opt)+"$");	            	
			            	exit = true;
